...
public class MainWindow extends BasicWindow
{
    ...
    private static String trainingImagesPath = "src/image/train-images.idx3-ubyte";
    private static String trainingLabelsPath = "src/image/train-labels.idx1-ubyte";

    // Path to the tests sets
    private static String testImagesPath = "src/image/t10k-images.idx3-ubyte";
    private static String testLabelsPath = "src/image/t10k-labels.idx1-ubyte";
